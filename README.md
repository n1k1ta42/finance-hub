...
- **Docker Hub**: [https://hub.docker.com/u/финансхаб](https://hub.docker.com/u/финансхаб)
...
5. Или загрузка и запуск готовых образов с Docker Hub:
...
6. Откройте браузер и перейдите по адресу `http://localhost:3001`
...
Подробные инструкции по настройке автоматического деплоя можно найти в [.github/README.md](.github/README.md).
