...
- **Документация по развертыванию**: [Инструкция по настройке сервера](./docs/server-setup.md)
...
- [Инструкция по настройке сервера на Debian](./docs/server-setup.md)
...
Подробная информация о системных требованиях доступна в [инструкции по настройке сервера](./docs/server-setup.md#системные-требования).

## 📡 API

Бэкенд предоставляет RESTful API для взаимодействия с приложением:

- `/api/auth` - маршруты аутентификации и авторизации
...
Полную документацию API можно найти после запуска проекта по адресу `/api/docs`.
...
Проект использует GitHub Actions для автоматизации процессов разработки и развертывания:

### Автоматизированные процессы

- **Проверка Pull Request'ов**: линтинг, тесты и проверка сборки
- **Непрерывная интеграция**: тесты и сборка Docker-образов
- **Непрерывное развертывание**: автоматический деплой на сервер
- **Обслуживание сервера**: еженедельные проверки и обновления

### Структура Workflow

- `.github/workflows/main.yml` - основной пайплайн CI/CD
- `.github/workflows/pr.yml` - проверка Pull Request'ов
- `.github/workflows/maintenance.yml` - регулярное обслуживание сервера

### Настройка CI/CD

Подробная инструкция по настройке CI/CD доступна в [документации по развертыванию сервера](./docs/server-setup.md#настройка-cicd-с-github-actions).
